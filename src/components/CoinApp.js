...
export default function CoinApp() {
    ...
    useEffect(() => {
        axios
            .get('https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=3&page=1&sparkline=false')
            .then(res => {
                setCoins(res.data);
    ...
    return (
        ...
        <div className="coin-app">
            <div className="coin-search">
                ...
                <form>
                    <input type="text" placeholder="Find your Crypto" className="coin-input" onChange={handleChange} />
                </form>
